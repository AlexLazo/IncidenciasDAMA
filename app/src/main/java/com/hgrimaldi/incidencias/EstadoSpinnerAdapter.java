...
public class EstadoSpinnerAdapter extends ArrayAdapter<EstadoModel> {

    public EstadoSpinnerAdapter(@NonNull Context context, ArrayList<EstadoModel> listaModel) {
    ...
    private View initView (int position, View convertView,ViewGroup parent){
        ...
        EstadoModel estado = getItem(position);
        if(estado != null){
